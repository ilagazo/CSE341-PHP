        ...
        <form action="" method="POST">
            ...
            <div class="product_container">
                <div class="product">
                    ...
                    <input type="number" id="prod1" name="prod1" min="0" max="3" value="0">
                ...
                <div class="product">
                    ...
                    <input type="number" id="prod2" name="prod2" min="0" max="3" value="0">
                ...
                <div class="product">
                    ...
                    <input type="number" id="prod4" name="prod4" min="0" max="3" value="0">
                ...
                <div class="product">
                    ...
                    <input type="number" id="prod5" name="prod5" min="0" max="3" value="0">
                    <br><br><label for="prod5">Aromatherapy Massage Package<br></label>
                </div>
            </div>
            <!-- Submit Button -->
            <button class="btn btn-outline-primary" type="submit" name="submit">Add to Cart</button>
            <a class="btn btn-outline-primary" href="../Project01/cart.php">Proceed to Cart</a>
        </form>
